(function ($) {
    ...
    function changeColor() {
        ...
        $('.quiz-box').css('background', '#217c7e');
      //  $('.option-input:checked::after').css('background', #FF9900);
    };
    ...
    Quiz.prototype.render = function (container) {
        ...
        $('#submitButton').click(function () {
            ...
            $('#result-stats').hide();
            //changeColor();
            $('.quiz-box').css('background', '#22bb33');
    ...
    var Question = function (count, question_string, correct_choice, wrong_choice1, wrong_choice2, wrong_choice3, wrong_choice4) {
        this.question_string = count + ". " + question_string;
        var wrong_choices = [];
        this.choices = [];
        var allchoice = [wrong_choice1, wrong_choice2, wrong_choice3, wrong_choice4]
        
        for (i = 0; i < allchoice.length; i++)
        {
             
            if (allchoice[i] != correct_choice) {
                
                wrong_choices[i] = allchoice[i];
        ...
        for (var i = 0; i < number_of_choices; i++) {
            if (i === this.correct_choice_index)
                ...
                if (wrong_choices[wrong_choice_index] == undefined) {
    ...
    Question.prototype.render = function (container) {
        ...
        for (var i = 0; i < this.choices.length; i++) {
            ...
            // Create the label
            if (this.choices[i] != undefined || this.choices[i] == '') {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < all_questions.length; i++) {
                    var question = new Question((i + 1), all_questions[i].questiondes, all_questions[i].correctans, all_questions[i].choice1, all_questions[i].choice2, all_questions[i].choice3, all_questions[i].choice4);
